...
- Download the `measurements.csv` file from [here] (Right click and save as a csv file) (https://raw.githubusercontent.com/the-pudding/data/master/pockets/measurements.csv) to your laptop. A big thanks to Jan Diehm and Amber Thomas for going around shops, measuring the jeans and putting the data online for everyone to use.  
